...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
	...
	$sql = "SELECT COUNT(*) total FROM proveedores WHERE year = '2022' and tipoFarmacia = 'intrahospitalaria 2022'";
    $result = mysqli_query($conexion2, $sql);
    $fila = mysqli_fetch_assoc($result);

    
    $query=$conexion2->query("SELECT proveedores.id_proveedor, 
    ...
    FROM proveedores left outer join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '2022' and tipoFarmacia = 'intrahospitalaria 2022' ORDER by proveedores.nombre_proveedor asc");
...
?>
    ...
    $totalContrato = $row['total'];
                ...
                $name = base64_encode($dataRegistro['nombre_proveedor']);
