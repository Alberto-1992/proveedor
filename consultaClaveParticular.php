...
$dateTo4 = base64_encode($dateTo3);
    ...
    $tabla="";
    $query="SELECT *
     from consumoscisfa where clavehraei = '$clave' and fecha between '$dateFrom3' and '$dateTo3' order by central asc limit 4000";
     
    $sql="SELECT sum(cantidad) as total
     from consumoscisfa where clavehraei = '$clave' and fecha between '$dateFrom3' and '$dateTo3'";
