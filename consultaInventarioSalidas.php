...
while($filaAlumnos= $buscarAlumnos->fetch_assoc())
	...
	$clave = base64_encode($filaAlumnos['id_controlMedicamento']);
        ...
        <tr>
            ...
            <td id="id_salida" name="" data-id_salida='.$filaAlumnos['id_controlMedicamento'].' contenteditable> </td>
...
actualizar_descripcion(id_3, nombre_3, "descripcion");
 ...
 $(document).on("blur", "#id_salida", function(){

let id_salida =$(this).data("id_salida");
let cantidad_salida = $(this).text();

$.ajax({
url: 'modelo/modelo_actualizar_inventario_salidas.php',
method: 'POST',
data: {id_salida:id_salida, cantidad_salida:cantidad_salida},
