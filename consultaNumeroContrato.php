...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
    ...
    tipoadjudicacion,
    LEFT(domicilio_proveedor,250) AS domicilio_proveedor FROM proveedores where numero_pedido = '$numerocontrato' and tipoFarmacia = 'intrahospitalaria 2022' or numero_pedido = '$numerocontrato' and tipoFarmacia = 'intrahospitalaria 2021' or numero_pedido = '$numerocontrato' and tipoFarmacia = 'intrahospitalaria 2021'";
