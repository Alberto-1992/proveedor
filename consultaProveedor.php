...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
	...
	$sql = "SELECT COUNT(*) total FROM proveedores WHERE nombre_proveedor = '$proveedor' and tipoFarmacia = 'intrahospitalaria 2022'";
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where datosproveedor.datoPersonalProveedor = '$proveedor' and proveedores.tipoFarmacia = 'intrahospitalaria 2022'";
