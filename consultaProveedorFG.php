...
error_reporting(0);
 ...
 $sql = "SELECT COUNT(*) total FROM proveedores WHERE nombre_proveedor = '$proveedor' and tipoFarmacia = 'gratutita 2022'";
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where datosproveedor.datoPersonalProveedor = '$proveedor' and proveedores.tipoFarmacia = 'gratutita 2022'";
