...
if(!empty($buscarAlumnos) AND mysqli_num_rows($buscarAlumnos)>0)
{
	...
	'<table class="table" style="background-color: #F5F5F5; border-radius: 10px;">
		<tr class="#" style="background-color:#184742; color: white;">
			<td>ID PROVEEDOR</td>
...
$("button").click(function() {
   ...
   var mensaje = confirm("¡La informacion se eliminara en su totalidad del sistema! ¿Desea continuar?");

if(mensaje == true){
	window.location.href="frontend/eliminaRegistr.php?id_proveedor="+fired_button;
}else{
