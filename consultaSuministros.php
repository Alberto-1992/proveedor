...
$year = $_POST['year'];
    ...
    $query=$conexion2->query("SELECT datosproveedor.datoPersonalProveedor, datosproveedor.telefono, datosproveedor.correoElectronico, proveedores.numero_pedido, proveedores.id_proveedor, proveedores.cuentaOrdenSuminstro
     from proveedores left outer join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where proveedores.year = '$year' and proveedores.cuentaOrdenSuminstro = 1 and proveedores.tipoFarmacia='$tipoFarmacia' ORDER by datosproveedor.datoPersonalProveedor asc");
?>
    ...
    while($dataRegistro= mysqli_fetch_assoc($query))
        ...
        ?>
            ...
            <td><?php echo $dataRegistro['numero_pedido']; ?></td>
            <td><a href="vistaPDF?var='<?php echo $var ?>'&nombre='<?php echo $nombre ?>'"><i id="pdf" class="fas fa-file-pdf"  style="width: 50px; height: 20px;"></i></a></td> 
