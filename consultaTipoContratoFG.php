...
error_reporting(0);
 function formatMoney($number, $cents = 1) { // cents: 0=never, 1=if needed, 2=always
    ...
    $sql = "SELECT COUNT(*) total FROM proveedores WHERE tipoFarmacia = '$contrato' and year = '2022'";
    ...
    FROM proveedores inner join datosproveedor on datosproveedor.id_datoProveedor = proveedores.numero_proveedor where tipoFarmacia = '$contrato' and year = '2022' ORDER by proveedores.nombre_proveedor asc";
    ...
    ?>
        <script type="text/javascript">
            ...
            $("button").click(function () {
                ...
                if (mensaje == true) {
                    window.location.href = "eliminaProveedor?id_proveedor="+fired_button+"&nombre="+fired_button2;
                } else {
                    swal({
                    title: '¡CANCELADO!',
                    text: '',
