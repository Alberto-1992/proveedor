...
importe, 
claveContrato, 
claveUnicaOrden FROM ordensuministro where claveHraei like '%$ID_usuario%' and fechacontrato = '$fecha' and farmacia = 'intrahospitalaria' or cuadroBasico like '%$ID_usuario%' and fechacontrato = '$fecha' and farmacia = 'intrahospitalaria' or descripcionDelBien like '%$ID_usuario%' and fechacontrato = '$fecha' and farmacia = 'intrahospitalaria'");
