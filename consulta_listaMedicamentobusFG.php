...
CLAVEHRAEI, 
DESCRIPCION FROM listamedicamento where CLAVEHRAEI like '%$val%' and fechaContrato = '2022' and farmacia = 'gratuita' or DESCRIPCION like '%$val%' and fechaContrato = '2022'  and farmacia = 'gratuita' or CLAVEDECUADROBASICO like '%$val%' and fechaContrato = '2022'  and farmacia = 'gratuita'";
