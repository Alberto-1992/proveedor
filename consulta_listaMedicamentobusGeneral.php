...
CLAVEHRAEI, 
DESCRIPCION FROM listamedicamento where CLAVEHRAEI like '$val%' and fechaContrato = '2022' or DESCRIPCION like '%$val%' and fechaContrato = '2022' or CLAVEDECUADROBASICO like '%$val%' and fechaContrato = '2022'";
