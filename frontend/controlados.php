                    ...
                    <div class="contrato-nuevo">
                        ...
                        <div class="container" style="margin-top: -25px;">
                                ...
                                <div class="input-group" style="float:left; margin-top: 5px; width: 97.5%; margin-left: 16px;">
                                    ...
                                    <input  type="text" id="localizar" class="form-control" required="required" value="HRAEI-MD"
                                        onkeyup="mayus(this);" >
                                        
                                </div>
                                <input type="submit" name="guarda" class="btn btn-warning" value="Buscar Medicamento" 
                    onclick="btn_localizar();" style="width: 97.5%; margin-left: 16px; margin-top: 2px;">
