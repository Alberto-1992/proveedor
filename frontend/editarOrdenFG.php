            ...
            <div class="signup-form-container" style="margin-top: 0px; width: 99%; height: auto; background: none; margin-left: auto; margin-right: auto; padding: .10%;">
                    ...
                    <center>
                      <input type="hidden" id="claveContrato" value="<?php echo $id_unico3; ?>">
                        ...
                        <input type="hidden" id="contrato" value="<?php echo $contrato; ?>" requerided="requireded" style="width: 200px; border: none; height: 35px; color: black; border-radius: 10px;" ><br></center>
...
<script>
            ...
            function actualizar_consumo(id, texto, fired, fired2, fired3, columna){
                ...
                method: 'POST',
                data: {id:id, texto:texto, fired:fired, fired2:fired2, fired3:fired3, columna:columna},
                succes: function(data){
