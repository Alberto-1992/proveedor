...
succes: function(data){
  ...
  <div class=""><input type="submit" class="btn btn-success" data-toggle="modal"
                    data-target="#myModal_folioPenalizacion"
                    style="margin-left: 10px; background: none; color: blue; font-size: 14px; cursor: pointer; margin-top: 10px;"
                value="Cargar folio Penalización"></div>
     ...
     <td ><input type="text"  value="<?php echo formatMoney($total); ?>" onclick="location.reload()" readonly="readonly"></td>
                    ...
                    <option value=""> Seleccione el folio del oficio</option>
     ...
     var valor= $('#folio').val();
                                ...
                                window.location.href = 'informePenalizacion?totalMaximoPenalizar='+fired_button9+'&totalMaximo='+fired_button8+'&valor='+valor+'&valor2='+fired_button2+'&var='+fired_button3+'&fecha='+fired_button4+'&fechaLimite='+fired_button6+'&valor3='+fired_button7;
