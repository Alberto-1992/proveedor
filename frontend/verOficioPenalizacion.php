...
$num = base64_decode($_GET['claveContrato']);
...
proveedores.email_proveedor, proveedores.numero_pedido, proveedores.numero_procedimiento, numeroorden.totalOrden, numeroorden.fechaRegistro from ordensuministro inner join proveedores on proveedores.id_proveedor =$var inner join numeroorden on claveUnicaContrato = '$num' and ordensuministro.claveUnicaOrden ='$num' and ordensuministro.claveContrato =$var and ordensuministro.cumplioEntrega = 'no'";
...
Centro Integral del Servicios Farmacéuticos.'), 0);
    ...
    $pdf->Cell(300, 30, ' ', 0);
    $pdf->Ln(1);
    $pdf->Cell(110, 25, ''.utf8_decode($row_s['nombre_proveedor']), 0);
    $pdf->Ln(25);
...
adjudicación en favor del proveedor '.$row_s['nombre_proveedor'].', relativo al contrato '.$row_s['numero_pedido'].' para la entrega de los siguientes insumos.'), 0);
...
$pdf->Cell(590, 5, '', 0);
$pdf->Ln(55);
$pdf->MultiCell(800, 12, utf8_decode('Al respecto me permito informale que a pesar de que el proveedor '.$row_s['nombre_proveedor'].' contaba con 15 dias naturales contados a partir del siguiente día
...
Por los anterior. se adjunta el cálculo realizado para determinar el importe de la pena convencional a que se hizo acreedor '.$row_s['nombre_proveedor'].', a fin de que 
