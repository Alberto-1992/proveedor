...
Centro Integral del Servicios Farmacéuticos.'), 0);
    ...
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(505, 25, '', 0);
    $pdf->Cell(300, 25, utf8_decode('Ixtapaluca, Estado de México a ').date('d-m-Y').'', 0);
    $pdf->Ln(25);
    $pdf->Cell(505, 25, '', 0);
...
$pdf->Cell(590, 5, '', 0);
$pdf->Ln(50);
$pdf->MultiCell(910, 12, utf8_decode('Al respecto me permito informale que a pesar de que el proveedor '.$row_s['nombre_proveedor'].' contaba con 15 dias naturales contados a partir del siguiente día
hábil de la emisión de la orden de suministro para la entrega de los insumos, se autorizó la recepción de los mismos con fechas posteriores en virtud de que existe la necesidad 
de estos para dar continuidad a los tratamientos farmacológicos de los pacientes del Hospital.
...
Lic. María del Carmen Espinoza Reyes
