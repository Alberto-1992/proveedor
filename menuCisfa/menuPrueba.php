    ...
    <nav class="main-menu">
        <ul>
            ...
            <li class="has-subnav">
                ...
                <ul style="background: #2e2f31;">
                    <li><a href="medicamentos" id="nav-text"><i class="fa fa-medkit fa-2x" id="icon-color"></i>
                            <span class="nav-text">Medicamento Cisfa
                            </span></a></li>
                    <li><a href="medicamentosFG" id="nav-text"><i class="fa fa-medkit fa-2x" id="icon-color"></i>
