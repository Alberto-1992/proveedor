<div id="myModal_listarMedicamentobus" class="modal fade" role="dialog">
...
<style>
    label{
        color: black;
                    ...
                    <div class="modal-body" >
                        <label>NOMBRE O CUADRO BASICO</label>  
                            <input list="consult_medicas" class="form-control" id="buscardor" name="" type="text"  onchange="btn_buscar_medicamento();">
           
        <datalist id="consult_medicas" >
            <?php
