...
?>
<div id="myModal_folioFG" class="modal fade" role="dialog">
    <style>
        label{
            color: black;
        }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content"
            ...
            <div class="modal-header" style="background: green; color: white;">
                ...
                <h4 class="modal-title"> Ingresa el número de orden FG </h4>
            </div>
            <div class="modal-body">
                ...
                <div id="panel_editar">
                        ...
                        <div class="cabecera-contrato">
                            <div class="imagen1"></div>
                                ...
                                <!-- form start -->
                                <form action="registrarFolioFG" method="POST">
                                        ...
                                        <div class="form-group"><br>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="id_proveedor" id="id_Proveedor"
                                                    ...
                                                    onkeyup="mayus(this);" readonly value="<?php echo $row['id_proveedor']; ?>">
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><span
                                                        class="glyphicon glyphicon-envelope"></span></div>
                                                <input name="numOrden" id="num_orden" type="text"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="fechaOrden" id="fecha_orden" type="hidden"
                                                    class="form-control" onkeyup="mayus(this);">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="rfc" id="rfc" type="hidden"
                                                    class="form-control" onkeyup="mayus(this);">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="direccionInternet" id="direccionInternet" type="hidden"
                                                    class="form-control" onkeyup="mayus(this);">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="correoElectronico" id="correoElectronico" type="hidden"
                                                    class="form-control" >
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-info" name="almacenarFolio" value="Guardar"
