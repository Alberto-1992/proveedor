...
$sql_s = $conexion2->query ("SELECT DISTINCT numero_pedido FROM proveedores where year = '2022' and tipoFarmacia = 'gratutita 2022' order by numero_pedido asc");
while ($row_s = mysqli_fetch_array($sql_s)) {
...
$sql_s = $conexion2->query ("SELECT DISTINCT tipoFarmacia FROM proveedores where year = 2022 and tipoFarmacia = 'gratutita 2022'");
while ($row_s = mysqli_fetch_array($sql_s)) {
