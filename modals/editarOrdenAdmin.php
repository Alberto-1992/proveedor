...
<input list="editarOrden" id="mySelectAdmin" class="form-control" name="Wz"  style="height: 35px;" onchange="selectAdmin(this.value);">
           
       <datalist id="editarOrden">
            <?php
            require 'conexion.php';
            $sql_s = $conexion2->query ("SELECT claveUnicaContrato FROM numeroorden where fechaRegistro like '%2022%' and estatus = 1 ");
     ...
     <input type="submit" name="guarda" class="btn btn-success" value="Buscar Orden" 
