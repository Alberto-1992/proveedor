        ...
        <div class="modal-content"
            ...
            <div class="modal-body">
                    ...
                    <div class="contrato-nuevo">
                        ...
                        <form action="editarOrdenFG" method="GET">
...
<input list="editarOrden" id="mySelect" class="form-control" name="Wz"  style="height: 35px;" onchange="select(this.value);">
       ...
       <datalist id="editarOrden">
            ...
            $sql_s = $conexion2->query ("SELECT claveUnicaContrato FROM numeroorden where fechaRegistro like '%2022%' and estatus = 1 and tipoFarmacia = 'gratuita'");
