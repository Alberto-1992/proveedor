...
<script src="scripts/medicamentoEnOrden.js"></script>
    ...
    <div class="modal-dialog">
        ...
        <datalist id="consult_medicaorden" >
            ...
            $sql_s = $conexion2->query ("SELECT DISTINCT cuadroBasico, descripcionDelBien FROM ordensuministro where fechacontrato = '2022'");
        ...
        <datalist id="consultaMedicamentoEnOrden" >
            <?php
            require 'conexion.php';
            $sql_s = $conexion2->query ("SELECT DISTINCT claveHraei, descripcionDelBien FROM ordensuministro where fechaContrato = '2021'");
            while ($row_s = mysqli_fetch_array($sql_s)) {
